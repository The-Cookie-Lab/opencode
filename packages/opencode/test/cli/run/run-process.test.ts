...
describe("opencode run (non-interactive subprocess)", () => {
  // These tests spawn nested CLI processes that may spawn shell commands; keep
  // them serial so Linux CI does not starve tool-continuation runs into timeout.
  const runIt = cliIt.live
