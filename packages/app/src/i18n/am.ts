export const dict = {
  ...
  "context.breakdown.detail.system_prompt": "የስርዓት ፕሮምፕት",
  "context.breakdown.detail.agent_instructions": "የወኪል መመሪያዎች",
  "context.breakdown.detail.tool_definitions": "የመሳሪያ ትርጓሜዎች",
  "context.breakdown.detail.user_messages": "የተጠቃሚ መልዕክቶች",
  "context.breakdown.detail.assistant_messages": "የረዳት መልዕክቶች",
  "context.breakdown.detail.tool_results": "የመሳሪያ ውጤቶች",
  "context.breakdown.detail.overhead": "ተጨማሪ ወጪ / ሌላ",
  "context.breakdown.detail.note": "ከሚገኝ መረጃ የተገመተ — ትክክለኛ የAPI ቶከን ቆጠራ አይደለም",
